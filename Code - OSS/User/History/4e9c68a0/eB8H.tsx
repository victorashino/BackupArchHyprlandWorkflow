    ...
    <Container className="items-center justify-center">
      ...
      <View className="w-full h-full relative items-end justify-end">
        <View className="w-full gap-4">
          ...
          >
            <Text className="text-[#253161] font-bold text-lg">{t('Initial.openAccount')}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={navigateToLogin}
            className="bg-transparent w-full border border-secondary flex items-center justify-center py-4 rounded-xl"
          >
            <Text className="text-secondary font-bold text-lg">{t('Initial.alreadyHaveAccount')}</Text>
          </TouchableOpacity>
          <TouchableOpacity className="bg-transparent flex items-center justify-center py-4 rounded-xl">
            <Text className="text-white font-bold text-lg">{t('Initial.needHelp')}</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Container>

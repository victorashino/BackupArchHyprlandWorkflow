...
const ProfilePage = () => {
    ...
    return (
        <View style={{
            ...
            <DropdownWithText title='Como alterar meu endereço? ' response='Na barra de navegação inferior, clique, entre em Perfil > Dados cadastrais > Editar endereço e siga as instruções para alterar seu endereço.'/>
            <DropdownWithText title='Como receber por QR code?' response=' 1. Na tela inicial, entre em Área PIX > Gerenciar chaves > Cadastrar nova chave.'/>

        ...
        <View className="mt-6 gap-2">
          <View className="gap-1">
            ...
            <View className="flex-row items-center justify-between gap-2">
              ...
              >
                <Text style={fontStyles.fontSemiBold} className="text-xl text-[#253060]">{t('Register.RegisterInformation.yes')}</Text>
              </Pressable>
              <Pressable
                onPress={desactivePolitically}
                className={`flex items-center justify-center w-1/2 h-14 rounded-xl ${!registerUser.politically_exposed ? 'bg-secondary' : 'bg-white'} `}
              >
                <Text style={fontStyles.fontSemiBold} className="text-xl text-[#253060]">{t('Register.RegisterInformation.no')}</Text>
              </Pressable>
            </View>
          </View>
          <View className="h-[2px] mt-4 w-full bg-white opacity-20"></View>
          <View className="gap-1">
            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.RegisterInformation.profession')}</Text>
            <MaskInput
          ...
          <View className="gap-1">
            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.RegisterInformation.approximateMonthlyIncome')}</Text>
            <TextInput

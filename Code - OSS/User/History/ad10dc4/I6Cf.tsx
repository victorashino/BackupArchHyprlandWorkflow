  ...
  return (
    <SafeAreaView className="flex-1 ">
      <Container className='h-[100vh]'>
        ...
        <View className="mt-5">
          <Text style={fontStyles.fontRegular} className="text-white">{t('Register.Profession.openAccount')}</Text>
          <Text style={fontStyles.fontSemiBold} className="text-white text-3xl font-semibold">{t('Register.Profession.tellUsMoreAboutYou')}</Text>
        </View>
        <View className="mt-6 gap-2">
          <View className="gap-1">
            <Text style={fontStyles.fontRegular} className="text-white text-sm">
            {t('Register.RegisterInformation.politicallyExposed')}
            </Text>
            <View className="flex-row items-center justify-between gap-2">
              ...
              >
                <Text style={fontStyles.fontSemiBold} className="text-xl text-[#253060]">{t('Register.Profession.yes')}</Text>
              </Pressable>
              <Pressable
                onPress={desactivePolitically}
                className={`flex items-center justify-center w-1/2 h-14 rounded-xl ${!registerUser.politically_exposed ? 'bg-secondary' : 'bg-white'} `}
              >
                <Text style={fontStyles.fontSemiBold} className="text-xl text-[#253060]">{t('Register.Profession.no')}</Text>
              </Pressable>
            </View>
          </View>
          <View className="h-[2px] mt-4 w-full bg-white opacity-20"></View>
          <View className="gap-1">
            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.Profession.profession')}</Text>
            <MaskInput
          ...
          <View className="gap-1">
            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.Profession.approximateMonthlyIncome')}</Text>
            <TextInput
          ...
          >
            <Text style={fontStyles.fontBold} className={'text-[#253161]'}>{t('Register.Profession.proceed')}</Text>
          </TouchableOpacity>
        </View>
      </Container>
    </SafeAreaView>

  ...
  return (
    <SafeAreaView className="flex-1 ">
      <Container className='h-[100vh]'>
        ...
        <View className="mt-5">
          <Text style={fontStyles.fontRegular} className="text-white">{t('Register.Identification.openAccount')}</Text>
          <Text style={fontStyles.fontSemiBold} className="text-white text-3xl">{t('Register.Identification.documentPhotos')}</Text>
        </View>
        <View className="mt-6 gap-2">
          <View className="gap-1">
            <View className="items-center justify-between gap-2">
              ...
              >
                <Text style={fontStyles.fontRegular} className="text-2xl font-medium text-[#253060]">{t('Register.Identification.rg')}</Text>
              </Pressable>
              <Pressable
                onPress={chooseCnh}
                className={`flex items-center justify-center w-full h-14 rounded-xl ${registerUser.doc_type === 'cnh' ? 'bg-secondary' : 'bg-white'} `}
              > 
                <Text style={fontStyles.fontRegular} className="text-2xl font-medium text-[#253060]">{t('Register.Identification.cnh')}</Text>
              </Pressable>
            </View>
          </View>
          ...
          >
            <Text style={fontStyles.fontBold} className={'text-[#253161]'}>{t('Register.Identification.proceed')}</Text>
          </TouchableOpacity>
        </View>
      </Container>
    </SafeAreaView>

...
const BoletoFinal: React.FC = () => {
  const { copyToClipboard, amount, tomorrow, handleBackPress, imageToBase64, convertCentsToReais, today, userInfo, setRegister } = useDeposit();
  ...
  return (
    <ContainerSession
      ...
      onBackPress={() => router.replace("/(home)/deposit/Boleto/final")}>
      ...
      {loading ? (
        ...
        <>
          ...
          <View style={styles.buttonsContainer}>
            <ButtonApp icon="download" text="Exportar boleto de recarga" submit={() => {

...
const BoletoFinal: React.FC = () => {
  const { copyToClipboard, amount, tomorrow, handleBackPress, imageToBase64 } = useDeposit();
  ...
  const exportPDF = async () => {
    try {
      ...
      const barCodeBase64 = await generateBarcodeBase64(String(barcode));
  ...
  const generateBarcodeBase64 = async (barcode: string): Promise<string> => {
    try {
      const pngBuffer = await bwipjs.toBuffer({
        bcid: 'code128', // Tipo de código de barras
        text: barcode,   // O código de barras que você quer gerar
        ...
        textxalign: 'center', // Alinhar o texto no centro
      });
    ...
    try {
      const html = `
        ...
        <body>
            ...
            <div class="info-container">
                <p>Data de emissão: </p> <p class="value">2024-09-18</p>
            </div>
            <div id="lineWrap"></div>
            <div class="info-container">
                <p>Nome do favorecido: </p> <p class="value">Fulano de Tal</p>
            </div>
            <div class="info-container">
                <p>Vencimento: </p> <p class="value">2024-09-25</p>
            </div>
            <div class="info-container">
                <p>Código de barras: </p>
                <p class="value">12345678901234567890123456789012345678901234</p>
            </div>
            <div class="barcode">

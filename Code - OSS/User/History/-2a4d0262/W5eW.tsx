...
import { ScrollView, Text, TouchableOpacity, View, ActivityIndicator, TouchableWithoutFeedback, StatusBar, RefreshControl } from 'react-native';
...
const ExtractPage: React.FC = () => {
  ...
  const onRefresh = useCallback(() => {
    setRefreshing(true);
    handleSubmit().finally(() => setRefreshing(false));
  }, []);

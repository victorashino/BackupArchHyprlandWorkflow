  ...
  return (
    <Container className='h-[100vh]'>
      ...
      <View className="mt-5">
        ...
        {t('Register.Register.enterDataBelow')}
        </Text>
      </View>
      <View className="mt-6 gap-2">
        <View className="gap-1">
          <Text style={fontStyles.fontLight} className="text-white text-sm">{t('Register.Register.fullName')}</Text>
          <MaskInput
        ...
        <View className="gap-1">
          <Text style={fontStyles.fontLight} className="text-white text-sm">{t('Register.Register.cpf')}</Text>
          <MaskInput
        ...
        <View className="gap-1">
          <Text style={fontStyles.fontLight} className="text-white text-sm">{t('Register.Register.cellPhone')}</Text>
          <MaskInput
        ...
        <View className="gap-1">
          <Text style={fontStyles.fontLight} className="text-white text-sm">{t('Register.Register.email')}</Text>
          <MaskInput
      ...
      >
        <Text style={fontStyles.fontBold} className={'text-[#253161]'}>{t('Register.Register.proceed')}</Text>
      </TouchableOpacity>
    </Container>
  )
}

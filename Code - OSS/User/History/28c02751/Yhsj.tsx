...
const Boleto = () => {
  const { register, setRegister, setAmount, setAmountToPass, handlePress, handleBackPress, amount } = useDeposit();
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={() => handlePress('/(home)/profile/faq')}>

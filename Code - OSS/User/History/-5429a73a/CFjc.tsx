  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ paddingTop: 62 }}>
        ...
        <ProfileButton icon="id-card" text="Dados cadastrais" navigateTo={"/(home)/profile/registrationData/registrationData"}/>
        <ProfileButton icon="lock" text="Alterar senha" navigateTo={"/(home)/profile/changePwd/sendCodeEmail"}/>

...
const Document = ({ navigation }) => {
    ...
    return (
        <Container className='h-[100vh]'>
            ...
            <View className="mt-5">
                <Text style={fontStyles.fontRegular} className="text-white">Dados</Text>
                <Text style={fontStyles.fontBold} className="text-white text-3xl font-semibold">do documento</Text>
            </View>
            <View className="mt-6 gap-2">
                <View className="gap-1">
                    <Text style={fontStyles.fontRegular} className="text-white text-sm">Número {registerUser.doc_type === "rg" ? "do RG" : "da CNH"}</Text>
                    <TextInput
            ...
            <View className="mt-6 gap-2">
                <View className="gap-1">
                    <Text style={fontStyles.fontRegular} className="text-white text-sm">Data de emissão</Text>
                    <MaskInput
            ...
            <View className="mt-6 gap-2">
                <View className="gap-1">
                    <Text style={fontStyles.fontRegular} className="text-white text-sm">Estado de emissão</Text>
                ...
                <View className="mt-6 gap-2">
                <View className="gap-1">
                    <Text style={fontStyles.fontRegular} className="text-white text-sm">Órgão emissor</Text>
                    <TextInput

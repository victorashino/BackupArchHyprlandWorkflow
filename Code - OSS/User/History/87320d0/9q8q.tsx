...
const FormTransferPage = () => {
    ...
    return (
        <ContainerSession backHomePage={false} titleHeader="Transferência" NameIcon="circle-question">
            <StatusBar barStyle="dark-content" />
            <SafeAreaView>
                <Text style={[globalFonts.regular16Gray, { marginBottom: 30 }]}>Adicione os dados da transferência:</Text>
                <View>
                    <InputApp
                        label="Banco"
                ...
                <View>
                    <Dropdown
                        label="Tipo de conta"
                        options={options}
                        setSelectedValue={(e: any) => setTransferData((prev: any) => ({
                            ...prev,
                            account_type: e
                        }))}
                        title="Tipo de conta"
                ...
                <View style={styles.containerAgencyAccount}>
                    ...
                    <View style={{ width: '55%' }}>
                        <InputApp
                            ...
                            type={transferData.doc_type === "cnh" ? "cnh" : transferData.doc_type === "rg" ? "rg" : "cpf"}

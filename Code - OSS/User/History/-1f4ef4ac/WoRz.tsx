      ...
      <Container className='h-[100vh]'>
        ...
        <View className="gap-4">
          <View className="flex-row items-center gap-2">
            ...
            {t('Register.FrontalPhotoInfo.removeFromPlastic')}
            </Text>
          </View>
          <View className="flex-row items-center gap-2">
            <View className="w-8">
            ...
            <Text style={fontStyles.fontSemiBold}  className="text-white text-lg">
            {t('Register.FrontalPhotoInfo.faceUp')}
            </Text>
          </View>
          <View className="flex-row items-center gap-2">
            <View className="w-8">
            ...
            <Text style={fontStyles.fontSemiBold}  className="text-white text-lg">
            {t('Register.FrontalPhotoInfo.checkFocus')}
            </Text>
          </View>
          <View className="flex-row items-center gap-2">
            <View className="w-8">
            ...
            <Text style={fontStyles.fontSemiBold}  className="text-white text-lg">
            {t('Register.FrontalPhotoInfo.frontOnly')}
            </Text>
          </View>
        </View>
        ...
        >
          <Text style={fontStyles.fontBold}  className="text-primary text-lg">{t('Register.FrontalPhotoInfo.proceed')}</Text>
        </TouchableOpacity>
      </Container>
    </View>
  )

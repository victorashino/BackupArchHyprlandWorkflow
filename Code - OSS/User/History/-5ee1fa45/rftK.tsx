...
export default function LastReleases({ releases }: ReleasesProps) {
    return (
        <View style={style.container}>
            <View style={{flexDirection: "row", width: 342, alignSelf: 'center', justifyContent: "space-between", marginTop: 16, marginBottom: 16}}>
                <Text style={fonts.regular14Gray}>Últimos lançamentos:</Text>
                <TouchableOpacity onPress={() => router.replace('/(home)/extract')}>
                    <Row>
                        <Text style={[fonts.regular14Gray, {marginEnd: 16}]}>Ver mais</Text>

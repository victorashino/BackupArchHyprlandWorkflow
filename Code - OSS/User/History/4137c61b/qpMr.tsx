...
const EnterPwdPage = () => {
    ...
    const validatePassword = (pwd: string) => {
        const hasLetters = /[a-zA-Z]/.test(pwd);   // Verifica se contém letras
        const hasNumbers = /\d/.test(pwd);         // Verifica se contém números
        const isValidLength = pwd.length > 6;      // Verifica se tem mais de 6 caracteres

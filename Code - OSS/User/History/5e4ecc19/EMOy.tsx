        ...
        <ContainerSession
            ...
            <View style={styles.containerButtonExport}>
                ...
                <View style={styles.containerButton}>
                    <TouchableOpacity style={styles.buttonContainerBlue} onPress={() => router.push("/(home)/profile/changePwd/enterCode")}>
                ...
                <View style={styles.containerButton}>
                    <TouchableOpacity style={styles.buttonContainerWhite} onPress={router.back}>
                        <View style={{ flexDirection: "row" }}>

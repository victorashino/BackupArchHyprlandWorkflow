                    ...
                    <div class="info">
                        ...
                        <div class="info-group">
                            ...
                            <div>
                                ...
                                <div class="info-value">${detail?.account?.documentNumber ? maskDocument(detail.account.documentNumber) : "Null"}</div>
                            </div>
                        </div>
                        <div class="info-group">
                            <div>
          ...
          : "Indisponível"
                    ...
                    <div class="info">
                        ...
                        <div class="info-group">
                            ...
                            <div>
                                <div class="info-title">CPF/CNPJ:</div>
                                <div class="info-value">${detail?.transactionData?.documentPayer ? maskDocument(detail.transactionData.documentPayer) : "Null"}</div>
                            </div>
                        </div>
                        <div class="info-group">
                            <div>
        ...
        <SafeAreaView style={{ flex: 1 }}>
          <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: 100 }}>
            ...
            <View style={styles.containerInfo}>
              ...
              <Text style={globalFonts.regular14Gray}>{detail.transactionData.recept_name}</Text>
            </View>
            <View style={styles.containerInfo}>
              <Text style={globalFonts.regular14}>CPF/CNPJ:</Text>
              <Text style={globalFonts.regular14Gray}>
                {detail?.transactionData?.recept_cpf_cnpj ? (detail.transactionData.recept_cpf_cnpj) : "Null"}
              </Text>
            </View>
            <View style={styles.containerInfo}>
            ...
            <View style={styles.containerInfo}>
              <Text style={globalFonts.regular14}>Nome:</Text>
              <Text style={globalFonts.regular14Gray}>{detail.transactionData.clientFantasyName || "Null"}</Text>
            </View>
            <View style={styles.containerInfo}>
              <Text style={globalFonts.regular14}>CPF/CPNJ:</Text>
              <Text style={globalFonts.regular14Gray}>
                {detail?.account?.documentNumber ? (detail.account.documentNumber) : "Null"}
              </Text>
            </View>
            <View style={styles.containerInfo}>
              <Text style={globalFonts.regular14}>Instituição:</Text>
            ...
            <View style={styles.containerInfo}>
              ...
              <Text style={globalFonts.regular14Gray}>{detail.transactionData.pixResponse.account.agency}</Text>
            </View>
            <View style={styles.containerInfo}>
              <Text style={globalFonts.regular14}>Conta:</Text>
              <Text style={globalFonts.regular14Gray}>
                {(detail.transactionData.pixResponse.account.number)}
              </Text>
            </View>
          </ScrollView>
...
export default PixOutComprovantePage;

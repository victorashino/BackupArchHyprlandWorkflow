                    ...
                    <div class="info">
                        ...
                        <div class="info-group">
                            <div>
                                ...
                                <div class="info-value">${detail.transactionData.recept_name}</div>
                            </div>
                            <div>
                                <div class="info-title">CPF/CNPJ:</div>
                                <div class="info-value">${detail.transactionData.recept_cpf_cnpj}</div>
                            </div>
                        </div>
                        <div class="info-group">
                            <div>
          ...
          : "Indisponível"
                    ...
                    <div class="info">
                        ...
                        <div class="info-group">
                            <div>
                                <div class="info-title">Nome:</div>
                                <div class="info-value">${detail.transactionData.clientFantasyName}</div>
                            </div>
                            <div>
                                <div class="info-title">CPF/CNPJ:</div>
                                <div class="info-value">${detail.account.documentNumber}</div>
                            </div>
                        </div>
                        <div class="info-group">
                            <div>
                            ...
                            <div>
                                ...
                                <div class="info-value">${(detail.account.number)}</div>
                            </div>
                        </div>
                    </div>

      ...
      <SafeAreaView style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: 100 }}>
          ...
          <View style={styles.containerInfo}>
            ...
            <Text style={globalFonts.regular14Gray}>
              {detail?.transactionData?.recept_cpf_cnpj ? maskDocument(detail.transactionData.recept_cpf_cnpj) : "Null"}
            </Text>
          </View>
          <View style={styles.containerInfo}>
          ...
          <View style={styles.containerInfo}>
            ...
            <Text style={globalFonts.regular14Gray}>
              {detail?.account?.documentNumber ? maskDocument(detail.account.documentNumber) : "Null"}
            </Text>
          </View>
          <View style={styles.containerInfo}>
            <Text style={globalFonts.regular14}>Instituição:</Text>
            <Text style={globalFonts.regular14Gray}>{detail.account.companyName || "Null"}</Text>
          </View>
          <View style={styles.containerInfo}>

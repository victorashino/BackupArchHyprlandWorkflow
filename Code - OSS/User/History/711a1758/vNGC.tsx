  ...
  return (
    <View className="flex-1">
      <Container className='h-[100vh]'>
        ...
        <View className="mt-5">
          <Text style={fontStyles.fontRegular} className="text-white text-lg">Resultado da</Text>
          <Text style={fontStyles.fontBold} className="text-white text-3xl">captura da foto</Text>
        </View>

      ...
      <Container className='h-[100vh]'>
        ...
        <View className="flex-row justify-between gap-4 mt-4">
          <TouchableOpacity
            ...
            onPress={changePhoto}
          >
            <Text style={fontStyles.fontBold} className={'text-[#253161] '}>{t('Register.SelfiePhoto.redoPhoto')}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            className={
          ...
          >
            <Text style={fontStyles.fontBold} className={'text-[#253161]'}>{t('Register.SelfiePhoto.proceed')}</Text>
          </TouchableOpacity>
        </View>
      </Container>
      {/* )} */}

...
const Dropdown = ({ title, label, options, value, setSelectedValue, required, align = false }: IPropsDropdown) => {
    ...
    const handleSelect = (option: OptionType) => {
        let selectedValue = ""
        if (!align) {
            selectedValue = typeof option === 'string' ? option : option.value;
        } else {
            selectedValue = typeof option === 'string' ? option : getLabel(option);
        }
                    ...
                    <View style={styles.overlay}>
                        <TouchableWithoutFeedback>
                            <View style={styles.dropdown}>
                                ...
                                <ScrollView style={align ? styles.containerOptionsAlign : styles.containerOptions}>

...
const ExtratoHome = () => {
  ...
  // Função para renderizar os extratos na ordem mais recente para o mais antigo
  const renderCardsAndExtracts = () => {
    // Transforma as entradas do objeto em um array de [data, extratos] e ordena pelo mais recente

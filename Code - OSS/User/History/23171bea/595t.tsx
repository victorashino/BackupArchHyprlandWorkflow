...
const ExtratoHome = () => {
  ...
  const handleDateChange = (date: string) => {
    // Aqui você pode realizar outras ações com a data selecionada
    console.log('Data selecionada:', date);
    // Por exemplo, atualizar o estado para uma nova busca
    setStart(date);
    setEnd(date); // ou qualquer outra ação necessária
  };
        ...
        >
          ...
          <Row marginBottom={10} marginEnd={4}>
            ...
            <ModalFilter
              ...
              onDateChange={handleDateChange} // Passando a função de callback
            />
          </Row>
          <Line />

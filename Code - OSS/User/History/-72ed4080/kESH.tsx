...
export const ExtractItem: React.FC<ItemProps> = ({ extract, maxWidth = true }) => {
  ...
  return (
    <View style={[styles.container, maxWidth? {width: "100%"} : {width: "90%"}]}>
      <TouchableOpacity onPress={navToComprovante}>
        ...
        >
          <Row>
            <View>
              <Row justify="flex-start" marginStart={0}>
                {extract.send === 1 ? (
                  <Row marginEnd={6}>

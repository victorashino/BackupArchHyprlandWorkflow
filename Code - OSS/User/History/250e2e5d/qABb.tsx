            ...
            <body>
                <div class="container">
                    <header>
                        ...
                        <p class="subtitle">Emitido em ${formattedDate}</p>
                    </header>
                    <div class="amount">
                    ...
                    <div class="info">
                        ...
                        <div class="info-group">
                            <div>
                                ...
                                <div class="info-value">${detail.transactionData.clientName}</div>
                            </div>
                            <div>
                                <div class="info-title">CPF/CNPJ:</div>
                                <div class="info-value">${(detail.transactionData.document)}</div>
                            </div>
                        </div>
                        <div class="info-group">
                            <div>
                            ...
                            <div>
                                ...
                                <div class="info-value">${detail.account.type === "CC" ? "Conta corrente" : "Conta Poupança"}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info">
                        ...
                        <div class="info-group">
                            ...
                            <div>
                                ...
                                <div class="info-value">${detail.transactionData.account}</div>
                            </div>
                        </div>
                    </div>
        ...
        <SafeAreaView style={{ flex: 1 }}>
          <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: 100 }}>
            ...
            <View style={styles.containerInfo}>
              ...
              <Text style={globalFonts.regular14Gray}>{detail.transactionData.clientName}</Text>
            </View>
            <View style={styles.containerInfo}>
              <Text style={globalFonts.regular14}>CPF/CNPJ:</Text>
              <Text style={globalFonts.regular14Gray}>
                {(detail.transactionData.document)}
              </Text>
            </View>
            <View style={styles.containerInfo}>
            ...
            <View style={styles.containerInfo}>
              ...
              <Text style={globalFonts.regular14Gray}>{detail.transactionData.agency}</Text>
            </View>
            <View style={styles.containerInfo}>
              <Text style={globalFonts.regular14}>Conta:</Text>
              <Text style={globalFonts.regular14Gray}>
                {(detail.transactionData.account)}
              </Text>
            </View>
          </ScrollView>

  ...
  return (
    <View className="flex-1">
      <Container className='h-[100vh]'>
        ...
        <View className="mt-5">
          <Text style={fontStyles.fontRegular} className="text-white">{t('Register.FrontalPhoto.openAccount')}</Text>
          <Text style={fontStyles.fontSemiBold} className="text-white text-3xl">{t('Register.FrontalPhoto.frontPhoto')}</Text>
        </View>
        ...
        <View className="flex-row justify-between gap-4 mt-4">
          <TouchableOpacity
            ...
            onPress={changePhoto}
          >
            <Text style={fontStyles.fontSemiBold} className={'text-[#253161]'}>{t('Register.FrontalPhoto.redoPhoto')}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            className={
          ...
          >
            <Text style={fontStyles.fontSemiBold} className={'text-[#253161]'}>{t('Register.FrontalPhoto.proceed')}</Text>
          </TouchableOpacity>
        </View>
      </Container>
    </View>

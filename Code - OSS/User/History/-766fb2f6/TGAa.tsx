...
const NotificationPage = () => {
    ...
    const renderRightActions = (id: number) => (
        <TouchableOpacity
            style={{ backgroundColor: "red", paddingHorizontal: 16, justifyContent: "center", marginStart: 18}}
                                ...
                                >
                                    <View style={styles.notification}>
                                        ...
                                        <View style={{ alignSelf: 'center' }}>
                                            <View style={{ flexDirection: "row", justifyContent: 'space-between', marginEnd: 32 }}>

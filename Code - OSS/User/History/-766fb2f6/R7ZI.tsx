...
// Tipagem dos dados de notificação
type Notification = {
    id: number;
    title: string;
    body: string;
...
const mockNotificationApi: MockNotificationApi = {
    listNotification: async () => {
        return new Promise((resolve) => setTimeout(() => resolve({ data: mockNotifications }), 1000));
    },
...
const NotificationPage = () => {
    ...
    const renderRightActions = (id: number) => (
        <TouchableOpacity
            style={{ marginTop: 3, borderRadius: 8, paddingHorizontal: 16, backgroundColor: 'red' }}
                    ...
                    Object.keys(groupedNotifications).map(date => (
                        <View key={date}>
                            ...
                            {groupedNotifications[date].map(item => (
                                ...
                                >
                                    <View style={{ flexDirection: "row", backgroundColor: colors.primaryWhite, alignSelf: "center" }}>
                                        ...
                                        <View style={{ alignSelf: 'center' }}>
                                            <View style={{ flexDirection: "row" }}>
                                                ...
                                                <Text style={fonts.regular14Gray}>{item.created}</Text>
                                            </View>
                                            <Text style={[fonts.regular14Gray, { maxWidth: 280 }]}>{item.body}</Text>
                                            <View>
                                                <Line />
                                            </View>
                                        </View>

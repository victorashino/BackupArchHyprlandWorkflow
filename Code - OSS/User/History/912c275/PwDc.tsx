...
const ConfirmPassword: React.FC = () => {
    ...
    const handlerPassword = async () => {
        try {
            ...
            const checkPass = await UserApi.checkPassword(valuePass)
                .then(async (res) => {
                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    <ContainerSession titleHeader="Insira sua senha" backHomePage={false}>
                        ...
                        <InputApp
                            ...
                            required
                            value={valuePass}
                            setState={(e: any) => handleChangePass(e)}
                            error={error}
                        />

                        <View style={[styles.menuButton, { marginBottom: keyboardVisible ? 20 : 0 }]}>
                            <ButtonApp color="blue" text="Transferir" submit={handlerPassword} />
                            <Text style={[globalFonts.regular14Red, { textAlign: "center", height: 50 }]}>
                                {errorMessage}
                            </Text>
                        </View>
                    </ContainerSession>

...
export interface ExtractContextType {
    startDefault: string;
    startPersonalizado: string;
    setStartDefault: (start: string) => void;
    setStartPersonalizado: (start: string) => void;
...
export const ExtractProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const [startDefault, setStartDefault] = useState<string>(getDateDaysAgo(90));
    const [startPersonalizado, setStartPersonalizado] = useState<string>(getDateDaysAgo(90));
    ...
    const data = { start: startPersonalizado, end, type };
    ...
    const setDefault = () => {
        ...
        setStartPersonalizado(getDateDaysAgo(90));
    ...
    const updateDropdownDisabled = (disabled: boolean) => {

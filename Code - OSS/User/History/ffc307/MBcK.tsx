...
export interface ExtractContextType {
    ...
    updateDropdownDisabled: (disabled: boolean) => void; // Renomeado
}
...
export const ExtractProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const [dropdownDisabled, setDropdownDisabled] = useState<boolean>(false); // Renomeado
    ...
    const updateDropdownDisabled = (disabled: boolean) => { // Renomeado
    ...
    return (
        <ExtractContext.Provider
            value={{
                ...
                getDateDaysAgo,
                handleDateChange,
                dropdownDisabled, // Renomeado
                updateDropdownDisabled, // Renomeado
            }}
        >
            {children}
        </ExtractContext.Provider>

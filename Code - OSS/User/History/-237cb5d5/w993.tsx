...
const FilterStartDates: React.FC = () => {
    const { start, setStart, getDateDaysAgo } = useExtract(); // Obtendo setStart e getDateDaysAgo do contexto
    ...
    const [selectedStartDays, setSelectedStartDays] = useState<number>(parseInt(start));

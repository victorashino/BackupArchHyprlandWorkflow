    ...
    return (
        <View style={style.container} accessibilityRole="progressbar" accessibilityLabel="Loading content">
            ...
            <ContentLoader
                ...
                <Rect x={7} y={510} rx={10} ry={10} width={"90%"} height={"5%"} />
                <Rect x={7} y={570} rx={10} ry={10} width={"100%"} height={"5%"} />
                <Rect x={7} y={630} rx={10} ry={10} width={"100%"} height={"5%"} />
                <Rect x={7} y={690} rx={10} ry={10} width={"100%"} height={"5%"} />

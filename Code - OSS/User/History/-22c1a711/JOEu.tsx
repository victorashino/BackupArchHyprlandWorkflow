      ...
      <SafeAreaView style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: 100 }}>
          ...
          <View style={styles.containerInfo}>
            ...
            <Text style={globalFonts.regular14Gray}>{detail.transactionData.clientName || "faltando"}</Text>
          </View>
          <View style={styles.containerInfo}>
          ...
          <View style={styles.containerInfo}>
            ...
            <Text style={globalFonts.regular14Gray}>
              {detail.transactionData.clientCompanyName}
            </Text>
          </View>
          <View style={styles.containerInfo}>
            <Text style={globalFonts.regular14}>Tipo de conta:</Text>
            <Text style={globalFonts.regular14Gray}>
              {transferData.account_type === "CC" ? "Conta corrente" : "Conta Poupança"}
            </Text>
          </View>
          <Line />

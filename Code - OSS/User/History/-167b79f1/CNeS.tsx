...
export default function CardBalance({ name, amount, account, agency, showGreeting = true, maxWidth = false }: CardBalanceProps) {
  return (
    <SafeAreaView style={[styles.area, maxWidth ? { width: "100%" } : {}]}>

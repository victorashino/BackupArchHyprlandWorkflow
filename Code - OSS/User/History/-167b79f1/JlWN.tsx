...
export default function CardBalance({ name, amount, account, agency, showGreeting = true, marginHorizontal = 32 }: CardBalanceProps) {
  return (
    <SafeAreaView style={[styles.area, {marginHorizontal: marginHorizontal}]}>

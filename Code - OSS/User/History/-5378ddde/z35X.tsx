            ...
            <ScrollView>
                <Container className='h-[100vh]'>
                    ...
                    <View className="mt-5">
                        ...
                        <Text style={fontStyles.fontSemiBold} className="text-white text-3xl">{t('Register.Address.yourAddress')}</Text>
                    </View>
                    <View className="mt-6 gap-2">
                        <View className="gap-1 ">
                            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.Address.zipCode')}</Text>
                    ...
                    <View className="mt-6 gap-2">
                        <View className="gap-1">
                            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.Address.street')}</Text>
                            <TextInput
                    ...
                    <View className="mt-6 gap-2">
                        <View className="gap-1">
                            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.Address.number')}</Text>
                            <TextInput
                    ...
                    <View className="mt-6 gap-2">
                        <View className="gap-1">
                            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.Address.complement')}</Text>
                            <TextInput
                    ...
                    <View className="mt-6 gap-2">
                        <View className="gap-1">
                            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.Address.neighborhood')}</Text>
                            <TextInput
                    ...
                    <View className="mt-6 gap-2">
                        <View className="gap-1">
                            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.Address.city')}</Text>
                            <TextInput
                    ...
                    <View className="mt-6 gap-2">
                        <View className="gap-1">
                            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.Address.state')}</Text>
                            <TextInput
                    ...
                    >
                        <Text style={fontStyles.fontBold} className={'text-[#253161]'}>{t('Register.Address.proceed')}</Text>
                    </TouchableOpacity>
                </Container>
            </ScrollView>
        </SafeAreaView>

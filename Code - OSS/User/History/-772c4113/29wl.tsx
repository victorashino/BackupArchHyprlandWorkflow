...
interface DatePickerButtonProps {
  ...
  text: string;
  onPress: () => void;
  showDateText: boolean; // Nova propriedade para controlar a exibição do texto da data
}

const DatePickerButton: React.FC<DatePickerButtonProps> = ({ date, text, onPress, showDateText }) => {
  return (

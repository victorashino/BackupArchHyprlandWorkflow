...
interface CheckCodeInviteProps {
    nextRoute: Href<string | object>;  // Ajusta o tipo para Href<string | object>
}

const CheckCodeInvite = ({ nextRoute }: CheckCodeInviteProps) => {
    ...
    const handleSubmit = async () => {
        try {
            await UserApi.checkCode(code)
                .then((res: any) => {
                    setRegister((prev) => ({
                        ...prev,
                        code: code,
                    }));
                    // Redireciona para a rota passada como prop

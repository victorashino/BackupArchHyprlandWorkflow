    ...
    <Container className="gap-4">
        ...
        <ScrollView>
          <View className="w-full flex-1 gap-3">
            ...
            <View className="relative bg-white rounded-md">
              <MaskInput
                placeholder={text.MaskInputPlaceHolder}
                onChangeText={(e) => {
                  setKeyPix(e)
                }}
      ...
      >
        <View style={styles.modalContent}>
          <Text style={styles.modalText}>{text.SelectKeyType}</Text>
          <TouchableOpacity
          ...
          >
            <Text style={styles.modalButtonText}>{text.CPF}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.modalButton}
            onPress={() => {
          ...
          >
            <Text style={styles.modalButtonText}>{text.Celular}</Text>
          </TouchableOpacity>
        </View>
      </Modal>
    </Container>

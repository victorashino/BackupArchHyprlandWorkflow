    ...
    <Container className="gap-4">
        ...
        <ScrollView>
          <View className="w-full flex-1 gap-3">
            ...
            <View>
              <Text 
                style={fontStyles.fontRegular}
                className="text-white text-[25px]">{text.alsoUse}</Text>
              <TouchableOpacity
      ...
      >
        <View style={styles.modalContent}>
          <Text style={styles.modalText}>{text.modal.message}</Text>
          <TouchableOpacity
          ...
          >
            <Text style={styles.modalButtonText}>{text.modal.cpf}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.modalButton}
            onPress={() => {
          ...
          >
            <Text style={styles.modalButtonText}>{text.modal.phone}</Text>
          </TouchableOpacity>
        </View>
      </Modal>
    </Container>

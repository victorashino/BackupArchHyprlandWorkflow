...
const AreaPixHome = ({ navigation }) => {
  ...
  const String = getTranslation().Pix
    ...
    <Container className="gap-4">
        ...
        <ScrollView>
          <View className="w-full flex-1 gap-3">
            ...
            <View className="relative bg-white rounded-md">
              <MaskInput
                placeholder={String.MaskInputPlaceHolder}
                onChangeText={(e) => {
                  setKeyPix(e)
                }}
            ...
            <View>
              <Text 
                style={fontStyles.fontRegular}
                className="text-white text-[25px]">{String.AlsoUse}</Text>
              <TouchableOpacity
      ...
      >
        <View style={styles.modalContent}>
          <Text style={styles.modalText}>{String.SelectKeyType}</Text>
          <TouchableOpacity
          ...
          >
            <Text style={styles.modalButtonText}>{String.CPF}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.modalButton}
            onPress={() => {
          ...
          >
            <Text style={styles.modalButtonText}>{String.Celular}</Text>
          </TouchableOpacity>
        </View>
      </Modal>
    </Container>

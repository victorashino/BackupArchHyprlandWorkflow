...
import TranslatePT from '@/assets/translate/pt.json'
import TranslateEN from '@/assets/translate/en.json'
import TranslateES from '@/assets/translate/es.json'
...
const AreaPixHome = ({ navigation }) => {
  ...
  const Translate = TranslatePT.Pix
  ...
  return (
    <Container className="gap-4">
      <Back title={Translate.ScreenTitle} />
        ...
        <ScrollView>
          <View className="w-full flex-1 gap-3">
            <Text 
              ...
              {Translate.SendPayments}
            </Text>
            <View className="relative bg-white rounded-md">
              <MaskInput
                placeholder={Translate.MaskInputPlaceHolder}
                onChangeText={(e) => {
                  setKeyPix(e)
                }}
            ...
            <View>
              <Text 
                style={fontStyles.fontRegular}
                className="text-white text-[25px]">{Translate.AlsoUse}</Text>
              <TouchableOpacity
      ...
      >
        <View style={styles.modalContent}>
          <Text style={styles.modalText}>{Translate.SelectKeyType}</Text>
          <TouchableOpacity
          ...
          >
            <Text style={styles.modalButtonText}>{Translate.CPF}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.modalButton}
            onPress={() => {
          ...
          >
            <Text style={styles.modalButtonText}>{Translate.Celular}</Text>
          </TouchableOpacity>
        </View>
      </Modal>
    </Container>

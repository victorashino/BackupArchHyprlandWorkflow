    ...
    return (
        <ScrollView
            ...
            <View style={{ width: 335, alignSelf: "center" }}>
                <Text style={[fonts.regular16, { alignSelf: "center", marginBottom: 48 }]}>
                    Para solicitar o encerramento de sua conta, lembre-se:
                </Text>

                <View style={{ marginHorizontal: "5%", marginBottom: 48 }}>
                    <LineWithText title='Solicitação por E-mail:' />
                    <Text style={[fonts.regular16Gray, {lineHeight: 32}]}>
                ...
                <View style={{ marginHorizontal: "5%", marginBottom: 74 }}>

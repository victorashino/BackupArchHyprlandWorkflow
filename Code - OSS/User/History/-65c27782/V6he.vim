...
" Selecionar palavras com Ctrl + Shift + setas (usando v para entrar no modo visual)
vnoremap <C-Left> b      " Seleciona a palavra anterior
vnoremap <C-Right> w     " Seleciona a próxima palavra

" Para garantir que você possa usar Ctrl + Shift + setas para seleção visual:
xnoremap <C-Left> b
xnoremap <C-Right> w
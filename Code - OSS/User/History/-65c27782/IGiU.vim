...
if exists('+termguicolors')
  ...
  let &t_8b = "\<Esc>[48;2;%lu;%lu;%lum"
    ...
    let g:coc_enable_location_list = 0
  set termguicolors
endif
...
" Mapeamento de Tab no modo de inserção (inserir um Tab literal)
inoremap <Tab> <Tab>

" Mapeamento de Shift+Tab no modo de inserção (remover indentação)
inoremap <S-Tab> <C-d>
...
" Mapeamento para pular palavra por palavra com Ctrl + setas
noremap <C-Left> b
noremap <C-Right> w

" Mapeamento para comentar e descomentar o bloco selecionado com Ctrl+/
vnoremap <C-/> :s/^/\/\/ /<CR>gv
vnoremap <C-S-/> :s/^\/\/ //<CR>gv


autocmd CursorHold * lua vim.diagnostic.hide()  " Para desativar diagnósticos ao parar o cursor

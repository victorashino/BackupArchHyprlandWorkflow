...
" Para C
autocmd FileType c nnoremap <S-F10> :w<CR>:!kitty --config .config/kitty/kitty.conf --hold sh -c 'gcc % -o %:r && ./%:r'<CR>

" Para C++
autocmd FileType cpp nnoremap <S-F10> :w<CR>:!kitty --config .config/kitty/kitty.conf --hold sh -c 'g++ % -o %:r && ./%:r'<CR>

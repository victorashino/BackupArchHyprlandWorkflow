...
" Para C
autocmd FileType c nnoremap <S-F10> :w<CR>:!kitty --config .config/kitty/kitty_dark.conf --hold sh -c "gcc % -o %:r && %:r"<CR>

" Para C++
autocmd FileType cpp nnoremap <S-F10> :w<CR>:!kitty --config .config/kitty/kitty_dark.conf --hold sh -c "g++ % -o %:r && %:r"<CR>
...
" Mapeamento CTRL Z para desfazer a ultima alteração
nnoremap <C-z> u

" Mapeamento para Ctrl+D para duplicar a linha atual
nnoremap <C-d> :t.<CR>
...
nnoremap <leader>r :CocCommand explorer.setRoot<CR>

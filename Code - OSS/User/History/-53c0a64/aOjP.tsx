...
const ModalFilter: React.FC<ModalFilterProps> = ({
  ...
  const openStartDatePicker = () => {
    ...
    setShowStartDateText(true); // Mostrar texto da data ao abrir o date picker de início
  };
  ...
  const openEndDatePicker = () => {
    ...
    setShowEndDateText(true); // Mostrar texto da data ao abrir o date picker de término
  };
  ...
  const handleButtonPressInternal = (buttonId: number) => {
    ...
    setShowStartDateText(false); // Ocultar texto da data ao selecionar um dos botões de período
    setShowEndDateText(false); // Ocultar texto da data ao selecionar um dos botões de período
  };
          ...
          <View style={styles.modalContent}>
            ...
            <Row marginTop={8}>
              <DatePickerButton
                ...
                text={'De'}
                showDateText={showStartDateText} // Passar propriedade para controlar visibilidade do texto da data
              />
              <DatePickerButton
                date={endDate ? formatarData(endDate) : ''}
                onPress={openEndDatePicker}
                text={'Até'}
                showDateText={showEndDateText} // Passar propriedade para controlar visibilidade do texto da data
              />
            </Row>

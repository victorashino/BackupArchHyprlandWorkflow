...
const ModalFilter: React.FC<ModalFilterProps> = ({
  ...
  const openStartDatePicker = () => {
    ...
    setEndDatePickerVisible(false); // Fechar o DatePicker de endDate se estiver aberto
  };
  ...
  const openEndDatePicker = () => {
    ...
    setStartDatePickerVisible(false); // Fechar o DatePicker de startDate se estiver aberto
  };

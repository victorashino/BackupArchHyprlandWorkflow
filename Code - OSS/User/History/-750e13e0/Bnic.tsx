  ...
  return (
    <Container className='h-[100vh]'>
      <View className="justify-between items-center">
        ...
        <Text style={fontStyles.fontSemiBold} className="text-white text-xl">Leia, é importante!</Text>
        <Text style={fontStyles.fontLight} className="w-full text-justify text-white mt-4 mb-4 text-[12px]">
          É com grande satisfação que lhe damos as boas-vindas. Aqui, a excelência em
          serviços financeiros encontra-se com a exclusividade para os nossos

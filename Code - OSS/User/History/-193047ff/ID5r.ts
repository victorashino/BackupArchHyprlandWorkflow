...
class UserApi {
  public async create(data: IRegisterSendUser) {
    ...
    // console.log("MULTFORMDATA DO REGISTRO ========================>: ", fd);
  ...
  public async updatePassword(pwd: string, newPwd: string) {
    return api.post("app/perfil/update_pwd", { pwd: md5(pwd), new_pwd: md5(newPwd) });
  }

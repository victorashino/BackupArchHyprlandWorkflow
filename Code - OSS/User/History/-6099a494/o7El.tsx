    ...
    return (
        <ContainerSession backHomePage={true} titleHeader="Alterar senha">
            <View style={styles.containerRobo}>
                ...
                />
                <View style={styles.containerTextRobo}>
                    <Text style={globalFonts.regular24White}>Seu endereço foi alterado</Text>
                    <Text style={[globalFonts.regular24White, {alignSelf: "center"}]}>com sucesso!</Text>
                </View>
                <View style={{width: "95%" }}>
                    <ButtonApp
                        text="Voltar à dados cadastrais"
                        color="yelow"
                        submit={() => router.push("/(home)/profile/registrationData/registrationData")}
                        disable={false}
                    />
                </View>
            </View>

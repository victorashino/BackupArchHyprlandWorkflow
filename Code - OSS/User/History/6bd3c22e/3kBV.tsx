        ...
        <Container className="gap-4">
            ...
            <View className="bg-background w-full flex-1 px-3 gap-3 rounded-lg">
                <View>
                    ...
                    <Column marginTop={16}>
                        <Text style={fontStyles.mediumBold}>Banco: <Text style={fontStyles.mediumRegular}>{accountData.bank}</Text></Text>
                        <Text style={fontStyles.mediumBold}>Agência: <Text style={fontStyles.mediumRegular}>{accountData.agency}</Text></Text>
                        <Text style={fontStyles.mediumBold}>Conta: <Text style={fontStyles.mediumRegular}>{accountData.account}</Text></Text>
                        <Text style={fontStyles.mediumBold}>Nome: <Text style={fontStyles.mediumRegular}>{accountData.name}</Text></Text>
                        <Text style={fontStyles.mediumBold}>Documento: <Text style={fontStyles.mediumRegular}>{accountData.doc}</Text></Text>
                        <Text style={fontStyles.mediumBold}>Email: <Text style={fontStyles.mediumRegular}>{accountData.email}</Text></Text>
                        <Text style={fontStyles.mediumBold}>Chave Pix: <Text style={fontStyles.mediumRegular}>{accountData.pix_key}</Text></Text>
                    </Column>
                    <Line marginTop={16} marginBottom={16} />
                    <Column>
                        <Card onPress={() => openModal('barcode')}>
                            <Image
                                style={{ marginEnd: 8, width: 28, height: 28 }}
                                source={require('@/assets/home/deposito/boleto.png')} />
                            <Text style={fontStyles.fontCard}>Gerar boleto de depósito</Text>
                        </Card>
                        <Card onPress={() => openModal('qrcode')}>
                            <Image
                                style={{ marginEnd: 8, width: 28, height: 28 }}

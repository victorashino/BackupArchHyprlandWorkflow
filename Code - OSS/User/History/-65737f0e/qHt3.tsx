...
interface IHeaderProps {
  ...
  const HeaderAreaHome = ({
    ...
    const handleBack = () => {
      // Se você deseja que o onBackPress sempre seja chamado, o coloque aqui
      if (onBackPress) {
        onBackPress(); // Chama a função onBackPress
      }
  
      // Depois, trata a navegação
      if (router.canGoBack()) {
        router.back();
      } else {

...
const TwoDatePickers: React.FC = () => {
    const { setStart, setEnd, handleDateChange } = useExtract();
    ...
    const onStartDateChange = (event: any, selectedDate?: Date) => {
        ...
        if (selectedDate) {
            ...
            setStart(formatDateForAPI(selectedDate)); // Atualiza o contexto com o formato yyyy-mm-dd
        }
    };
    ...
    const onEndDateChange = (event: any, selectedDate?: Date) => {
        ...
        if (selectedDate) {
            ...
            setEnd(formatDateForAPI(selectedDate)); // Atualiza o contexto com o formato yyyy-mm-dd
        }
    };

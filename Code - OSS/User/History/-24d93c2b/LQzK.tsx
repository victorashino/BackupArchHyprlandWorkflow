...
const TwoDatePickers: React.FC = () => {
    ...
    const onStartDateChange = (event: any, selectedDate?: Date) => {
        ...
        if (selectedDate) {
            ...
            setStart(formatDateForDisplay(selectedDate)); // Se necessário atualizar o contexto
        }
    };
    ...
    const onEndDateChange = (event: any, selectedDate?: Date) => {
        ...
        if (selectedDate) {
            ...
            setEnd(formatDateForDisplay(selectedDate)); // Se necessário atualizar o contexto
        }
    };

...
const TwoDatePickers: React.FC<TwoDatePickersProps> = ({ onDateChange }) => {
    ...
    const [datePickerUsed, setDatePickerUsed] = useState(false); // Estado para controlar o uso do DatePicker
    ...
    const onStartDateChange = (event: any, selectedDate?: Date | undefined) => {
        ...
        setDatePickerUsed(true); // Marca que o DatePicker foi usado
    };
    ...
    useEffect(() => {
        // Atualiza as datas selecionadas se o DatePicker foi usado
        if (datePickerUsed) {
            onDateChange(formatDate(startDate), formatDate(endDate), "range");
            setDatePickerUsed(false); // Reseta a flag após atualizar
        }
    }, [startDate, endDate]);
    ...
    return (
        <View style={styles.container}>
            <TouchableOpacity 
                ...
                disabled={datePickerUsed} // Desativa o botão se o DatePicker foi usado
            >

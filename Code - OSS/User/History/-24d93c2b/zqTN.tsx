...
const TwoDatePickers: React.FC = () => {
    ...
    useEffect(() => {
        // Atualiza o contexto com as datas selecionadas
        if (startDate) {
    ...
    return (
        <View style={styles.container}>
            ...
            >
                ...
                <Row justify='center'>
                    {/* Renderiza o texto da data apenas se startDate estiver definido */}
                    {startDate && (
            ...
            >
                ...
                <Row justify='center'>
                    {/* Renderiza o texto da data apenas se endDate estiver definido */}
                    {endDate && (
                        <Text style={[fonts.semiBold16, styles.date]}>

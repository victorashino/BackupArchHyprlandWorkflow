...
const TwoDatePickers: React.FC = () => {
    const { startPersonalizado, setStartPersonalizado, setEnd, setStartDefault } = useExtract();
    ...
    const onStartDateChange = (event: any, selectedDate?: Date) => {
        ...
        if (selectedDate) {
            ...
            setStartDefault(null); // Define startDefault como null quando uma data personalizada é selecionada
        }
    };

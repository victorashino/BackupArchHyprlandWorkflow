...
interface TwoDatePickersProps {
    ...
    isDropdownDisabled: boolean; // Adiciona uma prop para controlar o estado do dropdown
    setDropdownDisabled: (disabled: boolean) => void; // Função para atualizar o estado do dropdown
}
...
const TwoDatePickers: React.FC<TwoDatePickersProps> = ({ onDateChange, isDropdownDisabled, setDropdownDisabled }) => {
    ...
    const onStartDateChange = (event: any, selectedDate?: Date | undefined) => {
        ...
        setDropdownDisabled(true); // Desativa o dropdown quando uma data é selecionada
    };
    ...
    return (
        <View style={styles.container}>
            <TouchableOpacity 
                ...
                disabled={isDropdownDisabled} // Desativa o botão se o dropdown estiver desativado
            >

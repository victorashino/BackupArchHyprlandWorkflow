...
const TwoDatePickers: React.FC = () => {
    const { setStart, setEnd, getDateDaysAgo, setDropdownDisabled, isDropdownDisabled } = useExtract(); // Usa o contexto
    ...
    const onStartDateChange = (event: any, selectedDate?: Date) => {
        ...
        if (currentDate) {
            ...
            const daysAgo = calculateDaysAgo(currentDate); // Calcula o número de dias
            setStart(getDateDaysAgo(daysAgo)); // Usa a função do contexto para definir a data
    ...
    const onEndDateChange = (event: any, selectedDate?: Date) => {
        ...
        if (currentDate) {
            ...
            const daysAgo = calculateDaysAgo(currentDate); // Calcula o número de dias
            setEnd(getDateDaysAgo(daysAgo)); // Usa a função do contexto para definir a data
            setDropdownDisabled(true);
        }
    };

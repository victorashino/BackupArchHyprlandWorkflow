...
const TwoDatePickers: React.FC = () => {
    const { start, end, setStart, setEnd } = useExtract();
    ...
    useEffect(() => {
        // Atualiza os estados locais apenas quando start ou end são modificados diretamente do contexto
        if (start && !startDate) {
    ...
    return (
        <View style={styles.container}>
            ...
            >
                ...
                <Row justify='center'>
                    {/* Renderiza o texto da data apenas se startDate estiver definido e não for o valor padrão */}
                    {startDate && (
            ...
            >
                ...
                <Row justify='center'>
                    {/* Renderiza o texto da data apenas se endDate estiver definido e não for o valor padrão */}
                    {endDate && (
                        <Text style={[fonts.semiBold16, styles.date]}>

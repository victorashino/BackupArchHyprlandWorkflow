...
import TedScreen from '@/pages/tedTransfer/tedScreen'
import TedFormCheckoutScreen from '@/pages/tedTransfer/formCheckoutTed/formCheckoutTedScreen'
import DepositoHome from '@/pages/deposito'
...
export default function StackHome() {
  return (
    <Stack.Navigator initialRouteName="home">
      ...
      />
      <Stack.Screen
        name="FormCheckoutTedScreen"
        options={{ headerShown: false }}
        component={TedFormCheckoutScreen}
      />
      <Stack.Screen
        name="DepositoHome"
        options={{ headerShown: false }}
        component={DepositoHome}
      />
    </Stack.Navigator>
  )
}

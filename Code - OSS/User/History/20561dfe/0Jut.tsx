      ...
      <Container className='h-[100vh]'>
        ...
        <View className="gap-4">
          <View className="flex-row items-center gap-2">
            ...
            {t('Register.SelfieInfo.selfieInstructions')}
            </Text>
          </View>
          <View className="flex-row items-center gap-2">
            <View className="w-8">
            ...
            <Text style={fontStyles.fontBold} className="text-white text-lg">
            {t('Register.SelfieInfo.findWellLitPlace')}
            </Text>
          </View>
          <View className="flex-row items-center gap-2">
            <View className="w-8">
            ...
            <Text style={fontStyles.fontBold} className="text-white text-lg">
            {t('Register.SelfieInfo.removeAccessories')}
            </Text>
          </View>
          <View className="flex-row items-center gap-2">
            <View className="w-8">
            ...
            <Text style={fontStyles.fontBold} className="text-white text-lg">
            {t('Register.SelfieInfo.holdDocument')}
            </Text>
          </View>
        </View>
        ...
        >
          <Text style={fontStyles.fontBold} className={'text-[#253161]'}>{t('Register.SelfieInfo.proceed')}</Text>
        </TouchableOpacity>
      </Container>
    </View>
  )

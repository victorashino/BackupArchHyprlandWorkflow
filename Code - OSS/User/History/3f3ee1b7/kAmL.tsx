...
const RegisterInformation = ({ navigation }) => {
  ...
  const { t, i18n, } = useTranslation();
    ...
    const [genderItems, setGenderItems] = useState([
        { label: t('Register.RegisterInformation.male'), value: 'masculino' },
        { label: t('Register.RegisterInformation.female'), value: 'Feminino' },
        { label: t('Register.RegisterInformation.other'), value: 'Outros' }
    ])
    ...
    const [maritalStatusItems, setMaritalStatusItems] = useState([
        { label: t('Register.RegisterInformation.single'), value: 'Solteiro(a)' },
        { label: t('Register.RegisterInformation.married'), value: 'Casado(a)' },
        { label: t('Register.RegisterInformation.divorced'), value: 'Divorciado(a)' },
        { label: t('Register.RegisterInformation.widowed'), value: 'Viúvo(a)' }
    ])
            ...
            <ScrollView>
                <Container>
                    ...
                    <View className="mt-5">
                        ...
                        {t('Register.RegisterInformation.tellUsMoreAboutYou')}
                        </Text>
                    </View>
                    <View className="mt-6 gap-2">
                        <View className="gap-1">
                            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.RegisterInformation.motherName')}</Text>
                            <MaskInput
                        ...
                        <View className="gap-1">
                            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.RegisterInformation.gender')}</Text>
                            <DropDownPicker
                                open={genderOpen}
                        ...
                        <View className="gap-1">
                            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.RegisterInformation.maritalStatus')}</Text>
                            <DropDownPicker
                        ...
                        <View className="gap-1">
                            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.RegisterInformation.birthDate')}</Text>
                            <MaskInput
                        ...
                        <View className="gap-1">
                            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.RegisterInformation.nationality')}</Text>
                            <MaskInput
                        ...
                        <View className="gap-1">
                            <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.RegisterInformation.birthState')}</Text>
                        ...
                        </View>
                        {
                            uf.length !== 0 ? (
                                <View className="gap-1 h-[90px]">
                                    <Text style={fontStyles.fontRegular} className="text-white text-sm">{t('Register.RegisterInformation.birthCity')}</Text>
                                    {
                                        loading ? (
                    ...
                    >
                        <Text style={fontStyles.fontBold} className={'text-[#253161]'}>{t('Register.RegisterInformation.proceed')}</Text>
                    </TouchableOpacity>
                </Container>
            </ScrollView>
        </SafeAreaView>
